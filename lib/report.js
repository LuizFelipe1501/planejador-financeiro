...
// Versão estruturada: devolve os números-chave para preencher o template do
// relatório agendado (que não aceita quebras de linha nas variáveis).
export async function buildReportData(reference = new Date()) {
